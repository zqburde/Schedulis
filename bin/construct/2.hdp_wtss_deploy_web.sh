...
#execute ansible-playbook to install wtss web
#执行ansible-playbook脚本来安装wtss web
/usr/bin/ansible-playbook -i ${v_hosts} --extra-vars version=${version} hdp_wtss_deploy_web.yml
