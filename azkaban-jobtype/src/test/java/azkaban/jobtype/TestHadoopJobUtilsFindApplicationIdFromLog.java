...
public class TestHadoopJobUtilsFindApplicationIdFromLog {
  ...
  public void testLogWithMultipleApplicationIdsAppearingMultipleTimes() throws IOException {
    ...
    bw.write("28-08-2015 12:30:37 PDT Training_clickSelectFeatures INFO - INFO Closing idle connection Socket[addr=eat1-nertznn01.grid.linkedin.com/127.0.01,port=9000,localport=30453] to server eat1-nertznn01.grid.linkedin.com/127.0.01:9000\n");
